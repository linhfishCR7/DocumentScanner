...
Professional document scanning with OCR, PDF generation, and cloud storage integration

## 📱 App Information

- **Package Name:** `com.lehau.DocumentScanner`
...
1. Clone this repository:
   ```bash
   git clone https://github.com/linhfishCR7/DocumentScanner.git
   cd DocumentScanner
   ```
